...
with open(file='./Data_Testing/data_4.csv', mode='r', encoding='utf-8') as file:
...
for i in range(len(data)):
    ...
    # like
    like_btn = driver.find_element(By.ID, 'like1')
    like_btn.click()
    sleep(2.5)

    # unlike
    unlike_btn = driver.find_element(By.ID, 'like1')
    unlike_btn.click()
    sleep(2.5)
